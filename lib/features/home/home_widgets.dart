      ...
      _CarouselPage(
        ...
        child: Obx(
          () => _PokedexSummaryPage(
            ...
            totalShadow: service.totalShadow.value,
            totalPurified: service.totalPurified.value,
...
class _PokedexSummaryPage extends StatelessWidget {
  ...
  final int totalShadow;
  final int totalPurified;
  final int totalPokemon;

  const _PokedexSummaryPage({
    required this.totalOwned,
    required this.totalShiny,
    required this.totalShadow,
    required this.totalPurified,
